...
const IMPLEMENTATION_SOURCES: &[&str] = &[
    ...
    include_str!("postgres_tenant/capabilities.rs"),
    include_str!("postgres_tenant/config.rs"),
    include_str!("postgres_tenant/fence.rs"),
    include_str!("postgres_tenant/partition.rs"),
    include_str!("postgres_tenant/partition_store.rs"),
    include_str!("postgres_tenant/store.rs"),
    include_str!("postgres_tenant/tenant_store.rs"),
    include_str!("postgres_tenant/postgres_imp/mod.rs"),
    include_str!("postgres_tenant/postgres_imp/catalog.rs"),
    include_str!("postgres_tenant/postgres_imp/channels.rs"),
    include_str!("postgres_tenant/postgres_imp/connect.rs"),
    include_str!("postgres_tenant/postgres_imp/fixtures.rs"),
    include_str!("postgres_tenant/postgres_imp/fixtures_reset.rs"),
    include_str!("postgres_tenant/postgres_imp/leases.rs"),
    include_str!("postgres_tenant/postgres_imp/plans.rs"),
    include_str!("postgres_tenant/postgres_imp/provider_claim.rs"),
    include_str!("postgres_tenant/postgres_imp/provider_lifecycle.rs"),
    include_str!("postgres_tenant/postgres_imp/provider_queue.rs"),
    include_str!("postgres_tenant/postgres_imp/receipts.rs"),
    include_str!("postgres_tenant/postgres_imp/reconcile.rs"),
    include_str!("postgres_tenant/postgres_imp/rollbacks.rs"),
    include_str!("postgres_tenant/postgres_imp/runtime.rs"),
    include_str!("postgres_tenant/postgres_imp/schema.rs"),
