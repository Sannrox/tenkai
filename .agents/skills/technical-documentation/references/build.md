...
- Choose a page type before drafting (overview, quickstart, topic, guide, reference, troubleshooting, governance).
- Keep task-critical configuration inline; link exhaustive defaults, enums, schemas, generated references, and rare debugging workflows.
...
- If a repository-specific overlay exists under `references/`, apply its validation checklist.
